...
Config::Config(){
	...
	Abh[0] = Ability(50, 0, "Coup d epee");
	Abh[1] = Ability(400, 25, "Epee divine");
	heros[0] = new Character(800, 100, Abh, 2, "Guerrier", true);

	Abh[0] = Ability(75, 0, "Tir charge");
	Abh[1] = Ability(400, 25, "Tir perforant");
	heros[1] = new Character(500, 100, Abh, 2, "Chasseur", true);

	Abh[0] = Ability(150, 0, "Assassinat");
	Abh[1] = Ability(300, 15, "Coup Furtif");
	heros[2] = new Character(250, 100, Abh, 2, "Voleuse", true);

	Abh[0] = Ability(120, 0, "Brasier");
	Abh[1] = Ability(300, 15, "Foudre");
	heros[3] = new Character(350, 100, Abh, 2, "Mage", true);

	Ability *Abm = new Ability[1];
	Abm[0] = Ability(20, 2, "Morsure");
	monsters[0] = new Character(70, 100, Abm, 1, "Goule", false);

	Abm[0] = Ability(40, 4, "Griffe de l'ombre");
	monsters[1] = new Character(200, 100, Abm, 1, "Demon", false);

	Abm[0] = Ability(80, 8, "Souffle de Feu");
	monsters[2] = new Character(500, 100, Abm, 1, "Dragon", false);
}
...
void Config::editConfig() {
	...
	cout << "5." << monsters[0]->name << " : une créature monstrueuse " << endl;
	...
	case 3:
		...
		if(Charac->nbComp == 2) {
			...
			cout << "Quel caracteristique d'une compétence souhaitez-vous ? " << endl;
			cout << "1. Nom de la competence 1" << endl;
			cout << "2. Degat de la competence 1" << endl;
			cout << "3. Consomation de mana de la Compétence 1" << endl;
			cout << "4. Nom de la competence 2" << endl;
			cout << "5. Degat de la competence 2" << endl;
			cout << "6. Consomation de mana de la Compétence 2" << endl;
			cin >> choice;
			cout << "Nouvelle Valeur = " << endl;
			switch (choice) {
			case 1:
			...
			cout << "Quel caracteristique de compétence souhaitez-vous ? " << endl;
			cout << "1. Nom de la competence" << endl;
			cout << "2. Degat de la competence" << endl;
			cout << "3. Consomation de mana de la Compétence" << endl;
			cin >> choice;
			cout << "Nouvelle Valeur = " << endl;
			switch (choice) {
			case 1:
