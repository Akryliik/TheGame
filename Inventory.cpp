...
Inventory::Inventory(Config c){

	nbPotL = c->nbr_pot_perso; //nb de potion de vie dans l'inventaire / VALEUR A METTRE DANS CONFIG
	nbPotM = c->nbr_mana_perso; //nb de potion de mana dans l'inventaire / VALEUR A METTRE DANS CONFIG
}
